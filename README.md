# How to include python code inside bash script along with logging
...
# We want to include the logging also inside this
...
## Now we use the logging in the bash script along with python code
...
ctrl + shift + P > bash > set syntax Bash
